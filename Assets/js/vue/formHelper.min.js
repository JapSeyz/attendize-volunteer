...
!function (a) {
  function b(c, d) {
    ...
    var d = b.getAttribute("type"),
        e = "INPUT" === b.tagName && -1 !== a.inArray(d, c.supportsInputType) || b.isContentEditable || "TEXTAREA" === b.tagName;if (!e && "INPUT" === b.tagName) {
    ...
    function e(b) {
      ...
      if (null === f || "" === f) return void 0;if (1 === f.length && c.greedy === !1 && 0 !== c.repeat && (c.placeholder = ""), c.repeat > 0 || "*" === c.repeat || "+" === c.repeat) {
      ...
      if (c.mask.length > 1) {
        c.keepStatic = null === c.keepStatic ? !0 : c.keepStatic;var i = "(";return a.each(c.numericInput ? c.mask.reverse() : c.mask, function (b, c) {
    ...
    function i(a, b, c) {
      b = b || 0;var d,
          ...
          h = [],
          i = 0,
          j = o();ga = void 0 !== ea ? ea.maxLength : void 0, -1 === ga && (ga = void 0);do {
        if (a === !0 && m().validPositions[i]) {
          var k = m().validPositions[i];e = k.match, d = k.locator.slice(), h.push(c === !0 ? k.input : H(i, e));
        } else f = r(i, d, i - 1), e = f.match, d = f.locator.slice(), (g.jitMasking === !1 || j > i || isFinite(g.jitMasking) && g.jitMasking > i) && h.push(H(i, e));i++;
      } while ((void 0 === ga || ga > i) && (null !== e.fn || "" !== e.def) || b > i);return "" === h[h.length - 1] && h.pop(), m().maskLength = i + 1, h;
    }function m() {
      return f;
    }function n(a) {
      var b = m();b.buffer = void 0, a !== !0 && (b.tests = {}, b._buffer = void 0, b.validPositions = {}, b.p = 0);
    }function o(a, b, c) {
      var d = -1,
          e = -1,
          f = c || m().validPositions;void 0 === a && (a = -1);for (var g in f) {
        var h = parseInt(g);f[h] && (b || null !== f[h].match.fn) && (a >= h && (d = h), h >= a && (e = h));
      ...
      if (e || g.insertMode && void 0 !== m().validPositions[b] && void 0 === d) {
        ...
        }m().validPositions[b] = c;var j,
            k = !0,
            l = m().validPositions,
            p = !1;for (f = j = b; i >= f; f++) {
          var q = h[f];if (void 0 !== q) for (var r = j, s = -1; r < m().maskLength && (null == q.match.fn && l[f] && (l[f].match.optionalQuantifier === !0 || l[f].match.optionality === !0) || null != q.match.fn);) {
            if (null === q.match.fn || !g.keepStatic && l[f] && (void 0 !== l[f + 1] && v(f + 1, l[f].locator.slice(), f).length > 1 || void 0 !== l[f].alternation) ? r++ : r = D(j), p === !1 && h[r] && h[r].match.def === q.match.def) {
              m().validPositions[r] = a.extend(!0, {}, h[r]), m().validPositions[r].input = q.input, j = r, k = !0;break;
            }if (t(r, q.match.def)) {
              var u = B(r, q.input, !0, !0);if (k = u !== !1, j = u.caret || u.insert ? o() : r, p = !0, k) break;
            } else {
              if (k = null == q.match.fn, s === r) break;s = r;
            }
          }if (!k) break;
        }if (!k) return m().validPositions = a.extend(!0, {}, h), n(!0), !1;
      } else m().validPositions[b] = c;return n(!0), !0;
    }function q(b, c, d, e) {
      function f(a) {
        var b = m().validPositions[a];if (void 0 !== b && null === b.match.fn) {
          var c = m().validPositions[a - 1],
              d = m().validPositions[a + 1];return void 0 !== c && void 0 !== d;
        }return !1;
      }var h,
          i = b,
          j = a.extend(!0, {}, m().validPositions),
          k = !1;for (m().p = b, h = c - 1; h >= i; h--) {
        void 0 !== m().validPositions[h] && (d === !0 || !f(h) && g.canClearPosition(m(), h, o(), e, g) !== !1) && delete m().validPositions[h];
      }for (n(!0), h = i + 1; h <= o();) {
        for (; void 0 !== m().validPositions[i];) {
          i++;
        }var l = m().validPositions[i];if (i > h && (h = i + 1), void 0 === m().validPositions[h] && C(h) || void 0 !== l) h++;else {
          var p = r(h);k === !1 && j[i] && j[i].match.def === p.match.def ? (m().validPositions[i] = a.extend(!0, {}, j[i]), m().validPositions[i].input = p.input, delete m().validPositions[h], h++) : t(i, p.match.def) ? B(i, p.input || H(h), !0) !== !1 && (delete m().validPositions[h], h++, k = !0) : C(h) || (h++, i--), i++;
        }
      }n(!0);
    }function r(a, b, c) {
      var d = m().validPositions[a];if (void 0 === d) for (var e = v(a, b ? b.slice() : b, c), f = o(), h = m().validPositions[f] || v(0)[0], i = void 0 !== h.alternation ? h.locator[h.alternation].toString().split(",") : [], j = 0; j < e.length && (d = e[j], !(d.match && (g.greedy && d.match.optionalQuantifier !== !0 || (d.match.optionality === !1 || d.match.newBlockMarker === !1) && d.match.optionalQuantifier !== !0) && (void 0 === h.alternation || h.alternation !== d.alternation || void 0 !== d.locator[h.alternation] && A(d.locator[h.alternation].toString().split(","), i)))); j++) {}return d;
    }function s(a) {
      ...
      var d, e;return (m().tests[b] || m().validPositions[b]) && a.each(m().tests[b] || [m().validPositions[b]], function (a, b) {
        var f = b.alternation ? b.locator[b.alternation].toString().indexOf(c) : -1;(void 0 === e || e > f) && -1 !== f && (d = b, e = f);
      }), d;
    }function v(b, c, d) {
      function e(c, d, f, g) {
        function i(f, g, k) {
          function p(b, c) {
            ...
            var c = u(a, b);return c ? c.locator.slice(c.alternation + 1) : [];
          }if (j > 1e4) throw "Inputmask: There is probably an error in your mask definition or in the code. Create an issue on github with an example of the mask you are using. " + m().mask;if (j === b && void 0 === f.matches) return l.push({ match: f, locator: g.reverse(), cd: o }), !0;if (void 0 !== f.matches) {
            if (f.isGroup && k !== f) {
              if (f = i(c.matches[a.inArray(f, c.matches) + 1], g)) return !0;
            } else if (f.isOptional) {
              var r = f;if (f = e(f, d, g, k)) {
                if (h = l[l.length - 1].match, !p(h, r)) return !0;n = !0, j = b;
              }
              ...
              var s,
                  ...
                  w = l.slice(),
                  x = g.length,
                  y = d.length > 0 ? d.shift() : -1;if (-1 === y || "string" == typeof y) {
                var z,
                    A = j,
                    B = d.slice(),
                    C = [];if ("string" == typeof y) C = y.split(",");else for (z = 0; z < t.matches.length; z++) {
                  C.push(z);
                }for (var D = 0; D < C.length; D++) {
                  if (z = parseInt(C[D]), l = [], d = q(j, z), f = i(t.matches[z] || c.matches[z], [z].concat(g), k) || f, f !== !0 && void 0 !== f && C[C.length - 1] < t.matches.length) {
                    var E = a.inArray(f, c.matches) + 1;c.matches.length > E && (f = i(c.matches[E], [E].concat(g.slice(1, g.length)), k), f && (C.push(E.toString()), a.each(l, function (a, b) {
                      b.alternation = g.length - 1;
                    })));
                  }s = l.slice(), j = A, l = [];for (var F = 0; F < B.length; F++) {
                    d[F] = B[F];
                  }for (var G = 0; G < s.length; G++) {
                    var H = s[G];H.alternation = H.alternation || x;for (var I = 0; I < v.length; I++) {
                      var J = v[I];if (H.match.def === J.match.def && ("string" != typeof y || -1 !== a.inArray(H.locator[H.alternation].toString(), C))) {
                        H.match.mask === J.match.mask && (s.splice(G, 1), G--), -1 === J.locator[H.alternation].toString().indexOf(H.locator[H.alternation]) && (J.locator[H.alternation] = J.locator[H.alternation] + "," + H.locator[H.alternation], J.alternation = H.alternation);break;
                      }
                    }
                  }v = v.concat(s);
                ...
                })), l = w.concat(v), j = b, n = l.length > 0;
              } else f = i(t.matches[y] || c.matches[y], [y].concat(g), k);if (f) return !0;
              ...
              var M = c.matches[a.inArray(K, c.matches) - 1];if (f = i(M, [L].concat(g), M)) {
          ...
          if (c.matches[k].isQuantifier !== !0) {
            var p = i(c.matches[k], [k].concat(f), g);if (p && j === b) return p;if (j > b) break;
          }
        }
      }function f(b) {
        var c = [];return a.isArray(b) || (b = [b]), void 0 === b[0].alternation ? c = b[0].locator.slice() : a.each(b, function (a, b) {
        ...
        }if (m().tests[b] && m().tests[b][0].cd === o) return g(m().tests[b]);for (var r = k.shift(); r < i.length; r++) {
          var s = e(i[r], k, [r]);if (s && j === b || j > b) break;
        }
      }return (0 === l.length || n) && l.push({ match: { fn: null, cardinality: 0, optionality: !0, casing: null, def: "" }, locator: [], cd: o }), m().tests[b] = a.extend(!0, [], l), m().tests[b];
    }function w() {
      ...
      var d;if (c = c, a === !0) n(), a = 0, b = c.length;else for (d = a; b > d; d++) {
        delete m().validPositions[d], delete m().tests[d];
      }for (d = a; b > d; d++) {
        n(!0), c[d] !== g.skipOptionalPartCharacter && B(d, c[d], !0, !0);
      }
    }function z(a, c, d) {
      switch (c.casing) {case "upper":
          a = a.toUpperCase();break;case "lower":
          a = a.toLowerCase();break;case "title":
          var e = m().validPositions[d - 1];a = 0 === d || e && e.input === String.fromCharCode(b.keyCode.SPACE) ? a.toUpperCase() : a.toLowerCase();}return a;
    }function A(b, c) {
      ...
      function h(a) {
        ...
        var i = !1;return a.each(v(b), function (j, k) {
          for (var l = k.match, r = d ? 1 : 0, s = "", t = l.cardinality; t > r; t--) {
            ...
            var u = void 0 !== i.c ? i.c : d;u = u === g.skipOptionalPartCharacter && null === l.fn ? l.placeholder || l.def : u;var v = b,
                w = x();if (void 0 !== i.remove && (a.isArray(i.remove) || (i.remove = [i.remove]), a.each(i.remove.sort(function (a, b) {
              return b - a;
            }), function (a, b) {
              q(b, b + 1, !0);
              ...
              var A = i.refreshFromBuffer;if (e = !0, y(A === !0 ? A : A.start, A.end, w), void 0 === i.pos && void 0 === i.c) return i.pos = o(), !1;if (v = void 0 !== i.pos ? i.pos : b, v !== b) return i = a.extend(i, B(v, u, !0, f)), !1;
            } else if (i !== !0 && void 0 !== i.pos && i.pos !== b && (v = i.pos, y(b, v, x().slice()), v !== b)) return i = a.extend(i, B(v, u, !0)), !1;return i !== !0 && void 0 === i.pos && void 0 === i.c ? !1 : (j > 0 && n(!0), p(v, a.extend({}, k, { input: z(u, l, v) }), f, h(c)) || (i = !1), !1);
          }
        }), i;
      }function j(b, c, d, e) {
        for (var f, h, i, j, k, l, p = a.extend(!0, {}, m().validPositions), q = a.extend(!0, {}, m().tests), s = o(); s >= 0 && (j = m().validPositions[s], !j || void 0 === j.alternation || (f = s, h = m().validPositions[f].alternation, r(f).locator[j.alternation] === j.locator[j.alternation])); s--) {}if (void 0 !== h) {
          f = parseInt(f);for (var t in m().validPositions) {
            if (t = parseInt(t), j = m().validPositions[t], t >= f && void 0 !== j.alternation) {
              var v;0 === f ? (v = [], a.each(m().tests[f], function (a, b) {
                void 0 !== b.locator[h] && (v = v.concat(b.locator[h].toString().split(",")));
              })) : v = m().validPositions[f].locator[h].toString().split(",");var w = void 0 !== j.locator[h] ? j.locator[h] : v[0];w.length > 0 && (w = w.split(",")[0]);for (var x = 0; x < v.length; x++) {
                var y = [],
                    z = 0,
                    A = 0;if (w < v[x]) {
                  for (var C, D, E = t; E >= 0; E--) {
                    if (C = m().validPositions[E], void 0 !== C) {
                      var F = u(E, v[x]);m().validPositions[E].match.def !== F.match.def && (m().validPositions[E].generatedInput !== !0 && y.push(m().validPositions[E].input), m().validPositions[E] = F, m().validPositions[E].input = H(E), null === m().validPositions[E].match.fn && A++, C = F), D = C.locator[h], C.locator[h] = parseInt(v[x]);break;
                    }
                  }if (w !== C.locator[h]) {
                    for (k = t + 1; k < o(void 0, !0) + 1; k++) {
                      ...
                      var G = y.shift();if (G !== g.skipOptionalPartCharacter && !(i = B(o(void 0, !0) + 1, G, !1, e))) break;
                    }if (C.alternation = h, C.locator[h] = D, i) {
                      var I = o(b) + 1;for (k = t + 1; k < o() + 1; k++) {
                        l = m().validPositions[k], (void 0 === l || null == l.match.fn) && b > k && A++;
                      }b += A - z, i = B(b > I ? I : b, c, d, e);
                    }if (g.keepStatic = !g.keepStatic, i) return i;n(), m().validPositions = a.extend(!0, {}, p), m().tests = a.extend(!0, {}, q);
                  }
                }
              }break;
            }
      ...
      }e = e === !0;var l = c;void 0 !== c.begin && (l = ia && !h(c) ? c.end : c.begin);for (var s = !1, t = a.extend(!0, {}, m().validPositions), w = l - 1; w > -1 && !m().validPositions[w]; w--) {}var E, G;for (w++; l > w; w++) {
        void 0 === m().validPositions[w] && (g.jitMasking === !1 || g.jitMasking > w) && ((E = r(w)).match.def === g.radixPointDefinitionSymbol || !C(w, !0) || a.inArray(g.radixPoint, x()) < w && E.match.fn && E.match.fn.test(H(w), m(), w, !1, g)) && (G = o(w, !0) + 1, s = i(G, E.match.placeholder || (null == E.match.fn ? E.match.def : "" !== H(w) ? H(w) : x()[w]), !0, f), s !== !1 && (m().validPositions[s.pos || G].generatedInput = !0));
      }if (h(c) && (P(void 0, b.keyCode.DELETE, c), l = m().p), l < m().maskLength && (s = i(l, d, e, f), (!e || f === !0) && s === !1)) {
        var I = m().validPositions[l];if (!I || null !== I.match.fn || I.match.def !== d && d !== g.skipOptionalPartCharacter) {
          if ((g.insertMode || void 0 === m().validPositions[D(l)]) && !C(l, !0)) {
            var J = r(l).match;J = J.placeholder || J.def, i(l, J, e, f);for (var K = l + 1, L = D(l); L >= K; K++) {
              if (s = i(K, d, e, f), s !== !1) {
                k(l, K), l = K;break;
              }
            }
      ...
      var c;if (b ? (c = r(a).match, "" === c.def && (c = s(a))) : c = s(a), null != c.fn) return c.fn;if (b !== !0 && a > -1 && !g.keepStatic && void 0 === m().validPositions[a]) {
        var d = v(a);return d.length > 2;
      }return !1;
    }function D(a, b) {
      var c = m().maskLength;if (a >= c) return c;for (var d = a; ++d < c && (b === !0 && (s(d).newBlockMarker !== !0 || !C(d)) || b !== !0 && !C(d) && (g.nojumps !== !0 || g.nojumpsThreshold > d));) {}return d;
    }function E(a, b) {
      var c = a;if (0 >= c) return 0;for (; --c > 0 && (b === !0 && s(c).newBlockMarker !== !0 || b !== !0 && !C(c));) {}return c;
    }function F(a) {
      ...
      if (e && a.isFunction(g.onBeforeWrite)) {
        var h = g.onBeforeWrite(e, c, d, g);if (h) {
          if (h.refreshFromBuffer) {
            var i = h.refreshFromBuffer;y(i === !0 ? i : i.start, i.end, h.buffer || c), c = x(!0);
      ...
      if (b = b || s(a), void 0 !== b.placeholder) return b.placeholder;if (null === b.fn) {
        if (a > -1 && !g.keepStatic && void 0 === m().validPositions[a]) {
          var c,
              d = v(a),
              e = [];if (d.length > 2) for (var f = 0; f < d.length; f++) {
      ...
      function h() {
        var a = !1,
            b = w().slice(l, D(l)).join("").indexOf(k);if (-1 !== b && !C(l)) {
          a = !0;for (var c = w().slice(l, l + b), d = 0; d < c.length; d++) {
            if (" " !== c[d]) {
              a = !1;break;
            }
          }
          ...
          j = f.slice(),
          k = "",
          l = 0;if (n(), m().p = D(-1), !e) if (g.autoUnmask !== !0) {
        var p = w().slice(0, D(-1)).join(""),
            q = j.join("").match(new RegExp("^" + b.escapeRegex(p), "g"));q && q.length > 0 && (j.splice(0, q.length * p.length), l = D(l));
      } else l = D(l);a.each(j, function (b, d) {
        if (void 0 !== d) {
          var f = new a.Event("keypress");f.which = d.charCodeAt(0), k += d;var j = o(void 0, !0),
              p = m().validPositions[j],
              q = r(j + 1, p ? p.locator.slice() : void 0, j);if (!h() || e || g.autoUnmask) {
            var s = e ? b : null == q.match.fn && q.match.optionality && j + 1 < m().p ? j + 1 : m().p;i = R.call(c, f, !0, !1, e, s), l = s + 1, k = "";
          } else i = R.call(c, f, !0, !1, !0, j + 1);if (!e && a.isFunction(g.onBeforeWrite) && (i = g.onBeforeWrite(f, x(), i.forwardPosition, g), i && i.refreshFromBuffer)) {
            var t = i.refreshFromBuffer;y(t === !0 ? t : t.start, t.end, i.buffer), n(!0), i.caret && (m().p = i.caret);
          }
        }
      }), d && G(c, x(), document.activeElement === c ? D(o(0)) : void 0, new a.Event("checkval"));
    }function J(b) {
      if (b && void 0 === b.inputmask) return b.value;var c = [],
          d = m().validPositions;for (var e in d) {
        d[e].match && null != d[e].match.fn && c.push(d[e].input);
      }var f = 0 === c.length ? "" : (ia ? c.reverse() : c).join("");if (a.isFunction(g.onUnMask)) {
        var h = (ia ? x().slice().reverse() : x()).join("");f = g.onUnMask(h, f, g) || f;
      }return f;
    }function K(a, b, c, d) {
      function e(a) {
        if (d !== !0 && ia && "number" == typeof a && (!g.greedy || "" !== g.placeholder)) {
          var b = x().join("").length;a = b - a;
        }return a;
      ...
      }var k = i && void 0 !== i.alternation ? i.locator[i.alternation] : void 0;for (c = f - 1; c > g && (d = h[c], (d.match.optionality || d.match.optionalQuantifier || k && (k !== h[c].locator[i.alternation] && null != d.match.fn || null === d.match.fn && d.locator[i.alternation] && A(d.locator[i.alternation].toString().split(","), k.toString().split(",")) && "" !== v(c)[0].def)) && e[c] === H(c, d.match)); c--) {
        f--;
      }return b ? { l: f, def: h[f] ? h[f].match : void 0 } : f;
    }function M(a) {
      for (var b = L(), c = a.length - 1; c > b && !C(c); c--) {}return a.splice(b, c + 1 - b), a;
    }function N(b) {
      if (a.isFunction(g.isComplete)) return g.isComplete(b, g);if ("*" === g.repeat) return void 0;var c = !1,
          d = L(!0),
          e = E(d.l);if (void 0 === d.def || d.def.newBlockMarker || d.def.optionality || d.def.optionalQuantifier) {
        c = !0;for (var f = 0; e >= f; f++) {
          var h = r(f).match;if (null !== h.fn && void 0 === m().validPositions[f] && h.optionality !== !0 && h.optionalQuantifier !== !0 || null === h.fn && b[f] !== H(f, h)) {
            c = !1;break;
          }
        }
      }return c;
      ...
      function c(b) {
        if (a.valHooks && (void 0 === a.valHooks[b] || a.valHooks[b].inputmaskpatch !== !0)) {
          var c = a.valHooks[b] && a.valHooks[b].get ? a.valHooks[b].get : function (a) {
            ...
            return a.value = b, a;
              ...
              if (a.inputmask) {
                if (a.inputmask.opts.autoUnmask) return a.inputmask.unmaskedvalue();var b = c(a);return -1 !== o(void 0, void 0, a.inputmask.maskset.validPositions) || g.nullable !== !0 ? b : "";
              }return c(a);
        ...
        na.on(b, "mouseenter", function (b) {
          var c = a(this),
              d = this,
              e = d.inputmask._valueGet();e !== x().join("") && c.trigger("setvalue");
        });
        ...
        } else document.__lookupGetter__ && b.__lookupGetter__("value") && (h = b.__lookupGetter__("value"), i = b.__lookupSetter__("value"), b.__defineGetter__("value", d), b.__defineSetter__("value", e));b.inputmask.__valueGet = h, b.inputmask._valueGet = function (a) {
      ...
      function h() {
        if (g.keepStatic) {
          n(!0);var b,
              d = [],
              e = a.extend(!0, {}, m().validPositions);for (b = o(); b >= 0; b--) {
            var f = m().validPositions[b];if (f && (null != f.match.fn && d.push(f.input), delete m().validPositions[b], void 0 !== f.alternation && f.locator[f.alternation] === r(b).locator[f.alternation])) break;
          }if (b > -1) for (; d.length > 0;) {
            m().p = D(o());var h = new a.Event("keypress");h.which = d.pop().charCodeAt(0), R.call(c, h, !0, !1, !1, m().p);
      ...
      }d === b.keyCode.BACKSPACE && (e.end - e.begin < 1 || g.insertMode === !1) ? (e.begin = E(e.begin), void 0 === m().validPositions[e.begin] || m().validPositions[e.begin].input !== g.groupSeparator && m().validPositions[e.begin].input !== g.radixPoint || e.begin--) : d === b.keyCode.DELETE && e.begin === e.end && (e.end = C(e.end) ? e.end + 1 : D(e.end) + 1, void 0 === m().validPositions[e.begin] || m().validPositions[e.begin].input !== g.groupSeparator && m().validPositions[e.begin].input !== g.radixPoint || e.end++), q(e.begin, e.end, !1, f), f !== !0 && h();var j = o(e.begin);j < e.begin ? (-1 === j && n(), m().p = D(j)) : f !== !0 && (m().p = e.begin);
    }function Q(d) {
      var e = this,
          f = a(e),
          h = d.keyCode,
          i = K(e);if (h === b.keyCode.BACKSPACE || h === b.keyCode.DELETE || l && h === b.keyCode.BACKSPACE_SAFARI || d.ctrlKey && h === b.keyCode.X && !c("cut")) d.preventDefault(), P(e, h, i), G(e, x(), m().p, d, da !== x().join("")), e.inputmask._valueGet() === w().join("") ? f.trigger("cleared") : N(x()) === !0 && f.trigger("complete"), g.showTooltip && (e.title = g.tooltip || m().mask);else if (h === b.keyCode.END || h === b.keyCode.PAGE_DOWN) {
        d.preventDefault();var j = D(o());g.insertMode || j !== m().maskLength || d.shiftKey || j--, K(e, d.shiftKey ? i.begin : j, j, !0);
        ...
        var a = K(e);K(e, a.begin);
      }, 0) : h === b.keyCode.LEFT && setTimeout(function () {
        var a = K(e);K(e, ia ? a.begin + 1 : a.begin - 1);
      }, 0)) : (g.insertMode = !g.insertMode, K(e, g.insertMode || i.begin !== m().maskLength ? i.begin : i.begin - 1));g.onKeyDown.call(this, d, x(), K(e).begin, g), la = -1 !== a.inArray(h, g.ignorables);
    }function R(c, d, e, f, h) {
      var i = this,
          j = a(i),
          k = c.which || c.charCode || c.keyCode;if (!(d === !0 || c.ctrlKey && c.altKey) && (c.ctrlKey || c.metaKey || la)) return k === b.keyCode.ENTER && da !== x().join("") && (da = x().join(""), setTimeout(function () {
        j.trigger("change");
      }, 0)), !0;if (k) {
        46 === k && c.shiftKey === !1 && "," === g.radixPoint && (k = 44);var l,
            o = d ? { begin: h, end: h } : K(i),
            p = String.fromCharCode(k);m().writeOutBuffer = !0;var q = B(o, p, f);if (q !== !1) {
          var r = q.pos;if (n(!0), void 0 !== q.caret) l = q.caret;else {
            var s = m().validPositions;l = !g.keepStatic && (void 0 !== s[r + 1] && v(r + 1, s[r].locator.slice(), r).length > 1 || void 0 !== s[r].alternation) ? r + 1 : D(r);
          }m().p = l;
        }if (e !== !1) {
          var t = this;if (setTimeout(function () {
            g.onKeyValidation.call(t, k, q, g);
          }, 0), m().writeOutBuffer && q !== !1) {
            var u = x();G(i, u, g.numericInput && void 0 === q.caret ? E(l) : l, c, d !== !0), d !== !0 && setTimeout(function () {
      ...
      var c,
          ...
          i = K(d);ia && (c = i.end, i.end = i.begin, i.begin = c);var j = h.substr(0, i.begin),
          k = h.substr(i.end, h.length);j === (ia ? w().reverse() : w()).slice(0, i.begin).join("") && (j = ""), k === (ia ? w().reverse() : w()).slice(i.end).join("") && (k = ""), ia && (c = j, j = k, k = c), window.clipboardData && window.clipboardData.getData ? h = j + window.clipboardData.getData("Text") + k : e.clipboardData && e.clipboardData.getData && (h = j + e.clipboardData.getData("text/plain") + k);var l = h;if (a.isFunction(g.onBeforePaste)) {
        if (l = g.onBeforePaste(h, g), l === !1) return b.preventDefault();l || (l = h);
      }return I(d, !1, !1, ia ? l.split("").reverse() : l.toString().split("")), G(d, x(), D(o()), b, !0), N(x()) === !0 && f.trigger("complete"), b.preventDefault();
    }function T(c) {
      var d = this,
          e = d.inputmask._valueGet();if (x().join("") !== e) {
        var f = K(d);if (e = e.replace(new RegExp("(" + b.escapeRegex(w().join("")) + ")*"), ""), k) {
          var g = e.replace(x().join(""), "");if (1 === g.length) {
            var h = new a.Event("keypress");return h.which = g.charCodeAt(0), R.call(d, h, !0, !0, !1, m().validPositions[f.begin - 1] ? f.begin : f.begin - 1), !1;
          }
          ...
          for (var i = o() + 1, j = x().slice(i).join(""); null === e.match(b.escapeRegex(j) + "$");) {
            j = j.slice(1);
          }e = e.replace(j, ""), e = e.split(""), I(d, !0, !1, e), N(x()) === !0 && a(d).trigger("complete");
        } else c.keyCode = b.keyCode.BACKSPACE, Q.call(d, c);c.preventDefault();
      }
    }function U(b) {
      var c = this,
          d = c.inputmask._valueGet();I(c, !0, !1, (a.isFunction(g.onBeforeMask) ? g.onBeforeMask(d, g) || d : d).split("")), da = x().join(""), (g.clearMaskOnLostFocus || g.clearIncomplete) && c.inputmask._valueGet() === w().join("") && c.inputmask._valueSet("");
    }function V(a) {
      var b = this,
          c = b.inputmask._valueGet();g.showMaskOnFocus && (!g.showMaskOnHover || g.showMaskOnHover && "" === c) ? b.inputmask._valueGet() !== x().join("") && G(b, x(), D(o())) : ma === !1 && K(b, D(o())), g.positionCaretOnTab === !0 && setTimeout(function () {
        K(b, D(o()));
      }, 0), da = x().join("");
    }function W(a) {
      var b = this;if (ma = !1, g.clearMaskOnLostFocus && document.activeElement !== b) {
        var c = x().slice(),
            d = b.inputmask._valueGet();d !== b.getAttribute("placeholder") && "" !== d && (-1 === o() && d === w().join("") ? c = [] : M(c), G(b, c));
      }
    }function X(b) {
      function c(b) {
        if ("" !== g.radixPoint) {
          var c = m().validPositions;if (void 0 === c[b] || c[b].input === H(b)) {
            if (b < D(-1)) return !0;var d = a.inArray(g.radixPoint, x());if (-1 !== d) {
              for (var e in c) {
                if (e > d && c[e].input !== H(e)) return !1;
              }return !0;
            }
          }
        }return !1;
        ...
        if (document.activeElement === d) {
          var b = K(d);if (b.begin === b.end) switch (g.positionCaretOnClick) {case "none":
              break;case "radixFocus":
              if (c(b.begin)) {
                K(d, g.numericInput ? D(a.inArray(g.radixPoint, x())) : a.inArray(g.radixPoint, x()));break;
              }default:
              var e = b.begin,
                  f = o(e, !0),
                  h = D(f);if (h > e) K(d, C(e) || C(e - 1) ? e : D(e));else {
                var i = H(h);("" !== i && x()[h] !== i || !C(h, !0) && s(h).def === i) && (h = D(h)), K(d, h);
              }}
        }
      }, 0);
    }function Y(a) {
      ...
      var d = this,
          ...
          j = ia ? x().slice(f.end, f.begin) : x().slice(f.begin, f.end);i.setData("text", ia ? j.reverse().join("") : j.join("")), document.execCommand && document.execCommand("copy"), P(d, b.keyCode.DELETE, f), G(d, x(), m().p, c, da !== x().join("")), d.inputmask._valueGet() === w().join("") && e.trigger("cleared"), g.showTooltip && (d.title = g.tooltip || m().mask);
    }function $(b) {
      var c = a(this),
          d = this;if (d.inputmask) {
        var e = d.inputmask._valueGet(),
            f = x().slice();da !== f.join("") && setTimeout(function () {
          c.trigger("change"), da = f.join("");
        }, 0), "" !== e && (g.clearMaskOnLostFocus && (-1 === o() && e === w().join("") ? f = [] : M(f)), N(f) === !1 && (setTimeout(function () {
          c.trigger("incomplete");
        }, 0), g.clearIncomplete && (n(), f = g.clearMaskOnLostFocus ? [] : w().slice())), G(d, f, void 0, b));
      }
    }function _(a) {
      var b = this;ma = !0, document.activeElement !== b && g.showMaskOnHover && b.inputmask._valueGet() !== x().join("") && G(b, x());
    }function aa(a) {
      da !== x().join("") && fa.trigger("change"), g.clearMaskOnLostFocus && -1 === o() && ea.inputmask._valueGet && ea.inputmask._valueGet() === w().join("") && ea.inputmask._valueSet(""), g.removeMaskOnSubmit && (ea.inputmask._valueSet(ea.inputmask.unmaskedvalue(), !0), setTimeout(function () {
        G(ea, x());
      }, 0));
    }function ba(a) {
      setTimeout(function () {
      ...
      if (ea = b, fa = a(ea), g.showTooltip && (ea.title = g.tooltip || m().mask), ("rtl" === ea.dir || g.rightAlign) && (ea.style.textAlign = "right"), ("rtl" === ea.dir || g.numericInput) && (ea.dir = "ltr", ea.removeAttribute("dir"), ea.inputmask.isRTL = !0, ia = !0), na.off(ea), O(ea), d(ea, g) && (na.on(ea, "submit", aa), na.on(ea, "reset", ba), na.on(ea, "mouseenter", _), na.on(ea, "blur", $), na.on(ea, "focus", V), na.on(ea, "mouseleave", W), na.on(ea, "click", X), na.on(ea, "dblclick", Y), na.on(ea, "paste", S), na.on(ea, "dragdrop", S), na.on(ea, "drop", S), na.on(ea, "cut", Z), na.on(ea, "complete", g.oncomplete), na.on(ea, "incomplete", g.onincomplete), na.on(ea, "cleared", g.oncleared), g.inputEventOnly !== !0 && (na.on(ea, "keydown", Q), na.on(ea, "keypress", R)), na.on(ea, "input", T)), na.on(ea, "setvalue", U), "" !== ea.inputmask._valueGet() || g.clearMaskOnLostFocus === !1 || document.activeElement === ea) {
        var c = a.isFunction(g.onBeforeMask) ? g.onBeforeMask(ea.inputmask._valueGet(), g) || ea.inputmask._valueGet() : ea.inputmask._valueGet();I(ea, !0, !1, c.split(""));var e = x().slice();da = e.join(""), N(e) === !1 && g.clearIncomplete && n(), g.clearMaskOnLostFocus && document.activeElement !== ea && (-1 === o() ? e = [] : M(e)), G(ea, e), document.activeElement === ea && K(ea, D(o()));
      }
    }var da,
        ea,
        fa,
        ...
        la = !1,
        ma = !0,
        na = { on: function on(c, d, e) {
        var f = function f(c) {
          if (void 0 === this.inputmask && "FORM" !== this.nodeName) {
            var d = a.data(this, "_inputmask_opts");d ? new b(d).mask(this) : na.off(this);
          } else {
            if ("setvalue" === c.type || !(this.disabled || this.readOnly && !("keydown" === c.type && c.ctrlKey && 67 === c.keyCode || g.tabThrough === !1 && c.keyCode === b.keyCode.TAB))) {
              switch (c.type) {case "input":
                  if (ka === !0) return ka = !1, c.preventDefault();break;case "keydown":
                  ja = !1, ka = !1;break;case "keypress":
                  if (ja === !0) return c.preventDefault();ja = !0;break;case "click":
                  if (k) {
                    var f = this;return setTimeout(function () {
                      e.apply(f, arguments);
                    }, 0), !1;
                  }}var h = e.apply(this, arguments);return h === !1 && (c.preventDefault(), c.stopPropagation()), h;
            }c.preventDefault();
          }
        ...
        return ea = e.el, N(x());case "unmaskedvalue":
        return ea = e.el, void 0 !== ea && void 0 !== ea.inputmask ? (f = ea.inputmask.maskset, g = ea.inputmask.opts, ia = ea.inputmask.isRTL) : (ha = e.value, g.numericInput && (ia = !0), ha = (a.isFunction(g.onBeforeMask) ? g.onBeforeMask(ha, g) || ha : ha).split(""), I(void 0, !1, !1, ia ? ha.reverse() : ha), a.isFunction(g.onBeforeWrite) && g.onBeforeWrite(void 0, x(), 0, g)), J(ea);case "mask":
        ea = e.el, f = ea.inputmask.maskset, g = ea.inputmask.opts, ia = ea.inputmask.isRTL, da = x().join(""), ca(ea);break;case "format":
        ...
        g.numericInput && (ia = !0), e.value ? (ha = e.value.split(""), I(void 0, !1, !0, ia ? ha.reverse() : ha)) : e.value = x().join("");for (var oa = x(), pa = L(), qa = oa.length - 1; qa > pa && !C(qa); qa--) {}return oa.splice(pa, qa + 1 - pa), N(oa) && e.value === x().join("");case "getemptymask":
        return w().join("");case "remove":
        ea = e.el, fa = a(ea), f = ea.inputmask.maskset, g = ea.inputmask.opts, ea.inputmask._valueSet(J(ea)), na.off(ea);var ra;Object.getOwnPropertyDescriptor && Object.getPrototypeOf ? (ra = Object.getOwnPropertyDescriptor(Object.getPrototypeOf(ea), "value"), ra && ea.inputmask.__valueGet && Object.defineProperty(ea, "value", { get: ea.inputmask.__valueGet, set: ea.inputmask.__valueSet, configurable: !0 })) : document.__lookupGetter__ && ea.__lookupGetter__("value") && ea.inputmask.__valueGet && (ea.__defineGetter__("value", ea.inputmask.__valueGet), ea.__defineSetter__("value", ea.inputmask.__valueSet)), ea.inputmask = void 0;break;case "getmetadata":
        if (a.isArray(f.metadata)) {
          for (var sa, ta = o(void 0, !0), ua = ta; ua >= 0; ua--) {
            if (m().validPositions[ua] && void 0 !== m().validPositions[ua].alternation) {
              sa = m().validPositions[ua].alternation;break;
            }
    ...
    var b = ["/", ".", "*", "+", "?", "|", "(", ")", "[", "]", "{", "}", "\\", "$", "^"];return a.replace(new RegExp("(\\" + b.join("|\\") + ")", "gim"), "\\$1");
      ...
      j = /mobile/i.test(i),
      k = /iemobile/i.test(i),
      l = /iphone/i.test(i) && !k;return window.Inputmask = b, b;
}(jQuery), function (a, b) {
  return void 0 === a.fn.inputmask && (a.fn.inputmask = function (c, d) {
    var e,
        ...
        return f && f.inputmask ? f.inputmask.hasMaskedValue() : !1;case "isComplete":
        return f && f.inputmask ? f.inputmask.isComplete() : !0;case "getmetadata":
  ...
  return b.extendDefinitions({ h: { validator: "[01][0-9]|2[0-3]", cardinality: 2, prevalidator: [{ validator: "[0-2]", cardinality: 1 }] }, s: { validator: "[0-5][0-9]", cardinality: 2, prevalidator: [{ validator: "[0-5]", cardinality: 1 }] }, d: { validator: "0[1-9]|[12][0-9]|3[01]", cardinality: 2, prevalidator: [{ validator: "[0-3]", cardinality: 1 }] }, m: { validator: "0[1-9]|1[012]", cardinality: 2, prevalidator: [{ validator: "[01]", cardinality: 1 }] }, y: { validator: "(19|20)\\d{2}", cardinality: 4, prevalidator: [{ validator: "[12]", cardinality: 1 }, { validator: "(19|20)", cardinality: 2 }, { validator: "(19|20)\\d", cardinality: 3 }] } }), b.extendAliases({ "dd/mm/yyyy": { mask: "1/2/y", placeholder: "dd/mm/yyyy", regex: { val1pre: new RegExp("[0-3]"), val1: new RegExp("0[1-9]|[12][0-9]|3[01]"), val2pre: function val2pre(a) {
        ...
        if (isNaN(a)) return !1;var d = parseInt(a.concat(b.toString().slice(a.length))),
            e = parseInt(a.concat(c.toString().slice(a.length)));return (isNaN(d) ? !1 : d >= b && c >= d) || (isNaN(e) ? !1 : e >= b && c >= e);
      }, determinebaseyear: function determinebaseyear(a, b, c) {
        var d = new Date().getFullYear();if (a > d) return a;if (d > b) {
        ...
        for (var d = 0, e = 0, f = 0; f < a.length && "2" !== a.charAt(f); f++) {
          var g = c.definitions[a.charAt(f)];g ? (d += e, e = g.cardinality) : e++;
            ...
            var f = e.getFrontValue(b.mask, b.buffer, e);-1 !== f.indexOf(e.placeholder[0]) && (f = "01" + e.separator);var g = e.regex.val2(e.separator).test(f + a);if (!d && !g && (a.charAt(1) === e.separator || -1 !== "-./".indexOf(a.charAt(1))) && (g = e.regex.val2(e.separator).test(f + "0" + a.charAt(0)))) return b.buffer[c - 1] = "0", { refreshFromBuffer: { start: c - 1, end: c }, pos: c, c: a.charAt(0) };if (e.mask.indexOf("2") === e.mask.length - 1 && g) {
              var h = b.buffer.join("").substr(4, 4) + a;if (h !== e.leapday) return !0;var i = parseInt(b.buffer.join("").substr(0, 4), 10);return i % 4 === 0 ? i % 100 === 0 ? i % 400 === 0 ? !0 : !1 : !0 : !1;
            }return g;
          }, cardinality: 2, prevalidator: [{ validator: function validator(a, b, c, d, e) {
            ...
            if (e.isInYearRange(a, e.yearrange.minyear, e.yearrange.maxyear)) {
              var f = b.buffer.join("").substr(0, 6);if (f !== e.leapday) return !0;var g = parseInt(a, 10);return g % 4 === 0 ? g % 100 === 0 ? g % 400 === 0 ? !0 : !1 : !0 : !1;
            }return !1;
              ...
              var f = e.isInYearRange(a, e.yearrange.minyear, e.yearrange.maxyear);if (!d && !f) {
                var g = e.determinebaseyear(e.yearrange.minyear, e.yearrange.maxyear, a).toString().slice(0, 2);if (f = e.isInYearRange(a[0] + g[1] + a[1], e.yearrange.minyear, e.yearrange.maxyear)) return b.buffer[c++] = g.charAt(1), { pos: c };if (g = e.determinebaseyear(e.yearrange.minyear, e.yearrange.maxyear, a).toString().slice(0, 2), e.isInYearRange(g + a, e.yearrange.minyear, e.yearrange.maxyear)) {
                  var h = b.buffer.join("").substr(0, 6);if (h !== e.leapday) f = !0;else {
                    var i = parseInt(a, 10);f = i % 4 === 0 ? i % 100 === 0 ? i % 400 === 0 ? !0 : !1 : !0 : !1;
                  }
        ...
        var g = a(this);if (c.ctrlKey && c.keyCode === b.keyCode.RIGHT) {
          var h = new Date();g.val(h.getFullYear().toString() + (h.getMonth() + 1).toString() + h.getDate().toString()), g.trigger("setvalue");
            ...
            if ("24" === e.hourFormat && 24 === parseInt(a, 10)) return b.buffer[c - 1] = "0", b.buffer[c] = "0", { refreshFromBuffer: { start: c - 1, end: c }, c: "0" };var f = e.regex.hrs.test(a);if (!d && !f && (a.charAt(1) === e.timeseparator || -1 !== "-.:".indexOf(a.charAt(1))) && (f = e.regex.hrs.test("0" + a.charAt(0)))) return b.buffer[c - 1] = "0", b.buffer[c] = a.charAt(0), c++, { refreshFromBuffer: { start: c - 2, end: c }, pos: c, c: e.timeseparator };if (f && "24" !== e.hourFormat && e.regex.hrs24.test(a)) {
              var g = parseInt(a, 10);return 24 === g ? (b.buffer[c + 5] = "a", b.buffer[c + 6] = "m") : (b.buffer[c + 5] = "p", b.buffer[c + 6] = "m"), g -= 12, 10 > g ? (b.buffer[c] = g.toString(), b.buffer[c - 1] = "0") : (b.buffer[c] = g.toString().charAt(1), b.buffer[c - 1] = g.toString().charAt(0)), { refreshFromBuffer: { start: c - 1, end: c + 6 }, c: b.buffer[c] };
            }return f;
          }, cardinality: 2, prevalidator: [{ validator: function validator(a, b, c, d, e) {
  ...
  return b.extendDefinitions({ A: { validator: "[A-Za-zА-яЁёÀ-ÿµ]", cardinality: 1, casing: "upper" }, "&": { validator: "[0-9A-Za-zА-яЁёÀ-ÿµ]", cardinality: 1, casing: "upper" }, "#": { validator: "[0-9A-Fa-f]", cardinality: 1, casing: "upper" } }), b.extendAliases({ url: { definitions: { i: { validator: ".", cardinality: 1 } }, mask: "(\\http://)|(\\http\\s://)|(ftp://)|(ftp\\s://)i{+}", insertMode: !1, autoUnmask: !1 }, ip: { mask: "i[i[i]].i[i[i]].i[i[i]].i[i[i]]", definitions: { i: { validator: function validator(a, b, c, d, e) {
        ...
        return a;
      } }, email: { mask: "*{1,64}[.*{1,64}][.*{1,64}][.*{1,63}]@-{1,63}.-{1,63}[.-{1,63}][.-{1,63}]", greedy: !1, onBeforePaste: function onBeforePaste(a, b) {
        ...
        return a;
      } }, mac: { mask: "##:##:##:##:##:##" }, vin: { mask: "V{13}9{4}", definitions: { V: { validator: "[A-HJ-NPR-Za-hj-npr-z\\d]", cardinality: 1, casing: "upper" } }, clearIncomplete: !0, autoUnmask: !0 } }), b;
}(jQuery, Inputmask), function (a, b) {
  return b.extendAliases({ numeric: { mask: function mask(a) {
      ...
      }, placeholder: "", greedy: !1, digits: "*", digitsOptional: !0, radixPoint: ".", positionCaretOnClick: "radixFocus", groupSize: 3, groupSeparator: "", autoGroup: !1, allowPlus: !0, allowMinus: !0, negationSymbol: { front: "-", back: "" }, integerDigits: "+", integerOptional: !0, prefix: "", suffix: "", rightAlign: !0, decimalProtect: !0, min: null, max: null, step: 1, insertMode: !0, autoUnmask: !1, unmaskAsNumber: !1, postFormat: function postFormat(c, d, e) {
        e.numericInput === !0 && (c = c.reverse(), isFinite(d) && (d = c.join("").length - d - 1));var f,
            g,
            h = !1;c.length >= e.suffix.length && c.join("").indexOf(e.suffix) === c.length - e.suffix.length && (c.length = c.length - e.suffix.length, h = !0), d = d >= c.length ? c.length - 1 : d < e.prefix.length ? e.prefix.length : d;var i = !1,
            j = c[d],
            k = c.slice();j === e.groupSeparator && (k.splice(d--, 1), j = k[d]), j !== e.radixPoint && j !== e.negationSymbol.front && j !== e.negationSymbol.back && (k[d] = "?");var l = k.join(""),
            m = l;if (l.length > 0 && e.autoGroup || -1 !== l.indexOf(e.groupSeparator)) {
          var n = b.escapeRegex(e.groupSeparator);i = 0 === l.indexOf(e.groupSeparator), l = l.replace(new RegExp(n, "g"), "");var o = l.split(e.radixPoint);if (l = "" === e.radixPoint ? l : o[0], l !== e.prefix + "?0" && l.length >= e.groupSize + e.prefix.length) for (var p = new RegExp("([-+]?[\\d?]+)([\\d?]{" + e.groupSize + "})"); p.test(l) && "" !== e.groupSeparator;) {
          ...
          c[f] = l.charAt(f);
        }var q = a.inArray("?", c);if (-1 === q && (q = a.inArray(j, c)), c[q] = j, !i && h) for (f = 0, g = e.suffix.length; g > f; f++) {
        ...
        var g;if (c && ("blur" === c.type || "checkval" === c.type || "keydown" === c.type)) {
          var h = f.numericInput ? d.slice().reverse().join("") : d.join(""),
            ...
            var k = parseFloat(i),
                l = j ? -1 * k : k;if (null !== f.min && isFinite(f.min) && l < parseFloat(f.min) ? (k = Math.abs(f.min), j = f.min < 0, h = void 0) : null !== f.max && isFinite(f.max) && l > parseFloat(f.max) && (k = Math.abs(f.max), j = f.max < 0, h = void 0), i = k.toString().replace(".", f.radixPoint).split(""), isFinite(f.digits)) {
              var m = a.inArray(f.radixPoint, i),
                  n = a.inArray(f.radixPoint, h);-1 === m && (i.push(f.radixPoint), m = i.length - 1);for (var o = 1; o <= f.digits; o++) {
        ...
        if (!e && f.numericInput !== !0 && b === f.radixPoint && void 0 !== f.digits && (isNaN(f.digits) || parseInt(f.digits) > 0)) {
          var g = a.inArray(f.radixPoint, c.buffer),
              h = c.buffer.join("").match(f.regex.integerPart(f));if (-1 !== g && c.validPositions[g]) return c.validPositions[g - 1] ? { caret: g + 1 } : { pos: h.index, c: h[0], caret: g + 1 };if (!h || "0" === h[0] && h.index + 1 !== d) return c.buffer[h ? h.index : d] = "0", { pos: (h ? h.index : d) + 1, c: f.radixPoint };
        }return !1;
      }, leadingZeroHandler: function leadingZeroHandler(b, c, d, e, f, g) {
        if (!e) if (f.numericInput === !0) {
          var h = c.buffer.slice("").reverse(),
              i = h[f.prefix.length];if ("0" === i && void 0 === c.validPositions[d - 1]) return { pos: d, remove: h.length - f.prefix.length - 1 };
        } else {
          var j = a.inArray(f.radixPoint, c.buffer),
              k = c.buffer.slice(0, -1 !== j ? j : void 0).join("").match(f.regex.integerNPart(f));if (k && (-1 === j || j >= d)) {
            var l = -1 === j ? 0 : parseInt(c.buffer.slice(j + 1).join(""));if (0 === k[0].indexOf("" !== f.placeholder ? f.placeholder.charAt(0) : "0") && (k.index + 1 === d || g !== !0 && 0 === l)) return c.buffer.splice(k.index, 1), { pos: k.index, remove: k.index };if ("0" === b && d <= k.index && k[0] !== f.groupSeparator) return !1;
          }
        }return !0;
            ...
            var i = g.signHandler(c, d, e, f, g);if (!i && (i = g.radixHandler(c, d, e, f, g), !i && (i = f ? new RegExp("[0-9" + b.escapeRegex(g.groupSeparator) + "]").test(c) : new RegExp("[0-9]").test(c), i === !0 && (i = g.leadingZeroHandler(c, d, e, f, g, h), i === !0)))) {
              var j = a.inArray(g.radixPoint, d.buffer);i = -1 !== j && (g.digitsOptional === !1 || d.validPositions[e]) && g.numericInput !== !0 && e > j && !f ? { pos: e, remove: e } : { pos: e };
            }return i;
          }, cardinality: 1 }, "+": { validator: function validator(a, b, c, d, e) {
            var f = e.signHandler(a, b, c, d, e);return !f && (d && e.allowMinus && a === e.negationSymbol.front || e.allowMinus && "-" === a || e.allowPlus && "+" === a) && (f = d || "-" !== a ? !0 : "" !== e.negationSymbol.back ? { pos: c, c: "-" === a ? e.negationSymbol.front : "+", caret: c + 1, insert: { pos: b.buffer.length, c: e.negationSymbol.back } } : { pos: c, c: "-" === a ? e.negationSymbol.front : "+", caret: c + 1 }), f;
        ...
        if ("" === c && d.nullable === !0) return c;var e = a.replace(d.prefix, "");return e = e.replace(d.suffix, ""), e = e.replace(new RegExp(b.escapeRegex(d.groupSeparator), "g"), ""), d.unmaskAsNumber ? ("" !== d.radixPoint && -1 !== e.indexOf(d.radixPoint) && (e = e.replace(b.escapeRegex.call(this, d.radixPoint), ".")), Number(e)) : e;
  ...
  return b.extendAliases({ phone: { url: "phone-codes/phone-codes.js", countrycode: "", phoneCodeCache: {}, mask: function mask(b) {
        if (void 0 === b.phoneCodeCache[b.url]) {
          var c = [];b.definitions["#"] = b.definitions[9], a.ajax({ url: b.url, async: !1, type: "get", dataType: "json", success: function success(a) {
              c = a;
      ...
      }, keepStatic: !1, nojumps: !0, nojumpsThreshold: 1, onBeforeMask: function onBeforeMask(a, b) {
              ...
              var d = !1;c && (m += "(", o++);for (var e = 0; e < b.matches.length; e++) {
                var f = b.matches[e];if (f.isGroup === !0) d = i(f, !0);else if (f.isQuantifier === !0) {
                  var g = a.inArray(f, b.matches),
                    ...
                    for (var l = 0, n = f.quantifier.max - 1; n > l && !(d = i(h, !0)); l++) {}m = k + "{" + f.quantifier.min + "," + f.quantifier.max + "}";
                  }
                } else if (void 0 !== f.matches) for (var p = 0; p < f.length && !(d = i(f[p], c)); p++) {} else {
                  var q;if ("[" == f.charAt(0)) {
                    q = m, q += f;for (var r = 0; o > r; r++) {
                      q += ")";
                    }var s = new RegExp("^(" + q + ")$");d = s.test(j);
                  } else for (var t = 0, u = f.length; u > t; t++) {
                    if ("\\" !== f.charAt(t)) {
                      q = m, q += f.substr(0, t + 1), q = q.replace(/\|$/, "");for (var r = 0; o > r; r++) {
                        q += ")";
...
//# sourceMappingURL=formHelper.min.js.map
